...
const TIPS_DATA = [
  ...
  { id: "t9", category: "dog", featured: false,
    title: { ko: "초콜릿, 왜 강아지에게 위험할까?", en: "Why chocolate is dangerous for dogs" },
  ...
  { id: "t13", category: "dog", featured: false,
    ...
    body: { ko: "예방접종 전후에는 감염 위험을 고려해 수의사와 상의하면서, 안전한 환경에서 다양한 소리·사람·물건을 천천히 경험하게 해주세요.", en: "Around the vaccination period, ask your veterinarian about infection risk and use controlled, safe exposure to different sounds, people and objects." } },
  ...
  { id: "t51", category: "food", featured: false,
    title: { ko: "사료는 갑자기 바꾸지 않기", en: "사료는 갑자기 바꾸지 않기" },
    summary: { ko: "새 사료는 기존 사료와 섞어 5~7일에 걸쳐 천천히 바꿔주세요.", en: "새 사료는 기존 사료와 섞어 5~7일에 걸쳐 천천히 바꿔주세요." },
    body: { ko: "새 사료는 기존 사료와 섞어 5~7일에 걸쳐 천천히 바꿔주세요. 아이마다 나이·체형·건강 상태가 다르므로 이상이 있거나 판단이 어려우면 수의사 또는 전문가와 상담해주세요.", en: "새 사료는 기존 사료와 섞어 5~7일에 걸쳐 천천히 바꿔주세요." } },
  { id: "t52", category: "food", featured: false,
    title: { ko: "간식은 하루 열량의 10% 이내", en: "간식은 하루 열량의 10% 이내" },
    summary: { ko: "간식이 많아지면 주식 섭취와 영양 균형이 흐트러질 수 있어요.", en: "간식이 많아지면 주식 섭취와 영양 균형이 흐트러질 수 있어요." },
    body: { ko: "간식이 많아지면 주식 섭취와 영양 균형이 흐트러질 수 있어요. 아이마다 나이·체형·건강 상태가 다르므로 이상이 있거나 판단이 어려우면 수의사 또는 전문가와 상담해주세요.", en: "간식이 많아지면 주식 섭취와 영양 균형이 흐트러질 수 있어요." } },
  { id: "t53", category: "food", featured: false,
    title: { ko: "물그릇은 매일 세척하기", en: "물그릇은 매일 세척하기" },
    summary: { ko: "신선한 물을 자주 갈고 물그릇의 미끈한 막도 매일 씻어주세요.", en: "신선한 물을 자주 갈고 물그릇의 미끈한 막도 매일 씻어주세요." },
    body: { ko: "신선한 물을 자주 갈고 물그릇의 미끈한 막도 매일 씻어주세요. 아이마다 나이·체형·건강 상태가 다르므로 이상이 있거나 판단이 어려우면 수의사 또는 전문가와 상담해주세요.", en: "신선한 물을 자주 갈고 물그릇의 미끈한 막도 매일 씻어주세요." } },
  { id: "t54", category: "food", featured: false,
    title: { ko: "사람 음식의 양념은 피하기", en: "사람 음식의 양념은 피하기" },
    summary: { ko: "소금·양념·기름이 많은 음식은 반려동물에게 부담이 될 수 있어요.", en: "소금·양념·기름이 많은 음식은 반려동물에게 부담이 될 수 있어요." },
    body: { ko: "소금·양념·기름이 많은 음식은 반려동물에게 부담이 될 수 있어요. 아이마다 나이·체형·건강 상태가 다르므로 이상이 있거나 판단이 어려우면 수의사 또는 전문가와 상담해주세요.", en: "소금·양념·기름이 많은 음식은 반려동물에게 부담이 될 수 있어요." } },
  { id: "t55", category: "food", featured: false,
    title: { ko: "급하게 먹는 아이는 슬로우피더", en: "급하게 먹는 아이는 슬로우피더" },
    summary: { ko: "너무 빨리 먹는다면 넓은 그릇이나 슬로우피더로 속도를 낮춰보세요.", en: "너무 빨리 먹는다면 넓은 그릇이나 슬로우피더로 속도를 낮춰보세요." },
    body: { ko: "너무 빨리 먹는다면 넓은 그릇이나 슬로우피더로 속도를 낮춰보세요. 아이마다 나이·체형·건강 상태가 다르므로 이상이 있거나 판단이 어려우면 수의사 또는 전문가와 상담해주세요.", en: "너무 빨리 먹는다면 넓은 그릇이나 슬로우피더로 속도를 낮춰보세요." } },
  { id: "t56", category: "food", featured: false,
    title: { ko: "체중에 맞춰 급여량 점검", en: "체중에 맞춰 급여량 점검" },
    summary: { ko: "사료 봉지 권장량은 시작점이에요. 활동량과 체형에 맞춰 조절하세요.", en: "사료 봉지 권장량은 시작점이에요. 활동량과 체형에 맞춰 조절하세요." },
    body: { ko: "사료 봉지 권장량은 시작점이에요. 활동량과 체형에 맞춰 조절하세요. 아이마다 나이·체형·건강 상태가 다르므로 이상이 있거나 판단이 어려우면 수의사 또는 전문가와 상담해주세요.", en: "사료 봉지 권장량은 시작점이에요. 활동량과 체형에 맞춰 조절하세요." } },
  { id: "t57", category: "food", featured: false,
    title: { ko: "새 간식은 소량부터", en: "새 간식은 소량부터" },
    summary: { ko: "처음 먹는 간식은 아주 조금 주고 소화 상태와 알레르기 반응을 살펴보세요.", en: "처음 먹는 간식은 아주 조금 주고 소화 상태와 알레르기 반응을 살펴보세요." },
    body: { ko: "처음 먹는 간식은 아주 조금 주고 소화 상태와 알레르기 반응을 살펴보세요. 아이마다 나이·체형·건강 상태가 다르므로 이상이 있거나 판단이 어려우면 수의사 또는 전문가와 상담해주세요.", en: "처음 먹는 간식은 아주 조금 주고 소화 상태와 알레르기 반응을 살펴보세요." } },
  { id: "t58", category: "food", featured: false,
    title: { ko: "식사 시간은 일정하게", en: "식사 시간은 일정하게" },
    summary: { ko: "비슷한 시간에 급여하면 생활 리듬과 배변 패턴 관리에 도움이 돼요.", en: "비슷한 시간에 급여하면 생활 리듬과 배변 패턴 관리에 도움이 돼요." },
    body: { ko: "비슷한 시간에 급여하면 생활 리듬과 배변 패턴 관리에 도움이 돼요. 아이마다 나이·체형·건강 상태가 다르므로 이상이 있거나 판단이 어려우면 수의사 또는 전문가와 상담해주세요.", en: "비슷한 시간에 급여하면 생활 리듬과 배변 패턴 관리에 도움이 돼요." } },
  { id: "t59", category: "food", featured: false,
    title: { ko: "초콜릿·포도·양파는 금지", en: "초콜릿·포도·양파는 금지" },
    summary: { ko: "대표적인 위험 식품은 닿지 않는 곳에 보관하고 가족 모두가 공유해두세요.", en: "대표적인 위험 식품은 닿지 않는 곳에 보관하고 가족 모두가 공유해두세요." },
    body: { ko: "대표적인 위험 식품은 닿지 않는 곳에 보관하고 가족 모두가 공유해두세요. 아이마다 나이·체형·건강 상태가 다르므로 이상이 있거나 판단이 어려우면 수의사 또는 전문가와 상담해주세요.", en: "대표적인 위험 식품은 닿지 않는 곳에 보관하고 가족 모두가 공유해두세요." } },
  { id: "t60", category: "food", featured: false,
    title: { ko: "식욕 변화는 기록하기", en: "식욕 변화는 기록하기" },
    summary: { ko: "평소보다 갑자기 덜 먹거나 많이 먹는 변화가 이어지면 기록 후 상담해보세요.", en: "평소보다 갑자기 덜 먹거나 많이 먹는 변화가 이어지면 기록 후 상담해보세요." },
    body: { ko: "평소보다 갑자기 덜 먹거나 많이 먹는 변화가 이어지면 기록 후 상담해보세요. 아이마다 나이·체형·건강 상태가 다르므로 이상이 있거나 판단이 어려우면 수의사 또는 전문가와 상담해주세요.", en: "평소보다 갑자기 덜 먹거나 많이 먹는 변화가 이어지면 기록 후 상담해보세요." } },
  { id: "t61", category: "training", featured: false,
    title: { ko: "이름을 부르면 좋은 일이 생기게", en: "이름을 부르면 좋은 일이 생기게" },
    summary: { ko: "이름을 부른 뒤 바라보면 바로 칭찬해 이름에 긍정적인 의미를 만들어주세요.", en: "이름을 부른 뒤 바라보면 바로 칭찬해 이름에 긍정적인 의미를 만들어주세요." },
    body: { ko: "이름을 부른 뒤 바라보면 바로 칭찬해 이름에 긍정적인 의미를 만들어주세요. 아이마다 나이·체형·건강 상태가 다르므로 이상이 있거나 판단이 어려우면 수의사 또는 전문가와 상담해주세요.", en: "이름을 부른 뒤 바라보면 바로 칭찬해 이름에 긍정적인 의미를 만들어주세요." } },
  { id: "t62", category: "training", featured: false,
    title: { ko: "짧고 자주 훈련하기", en: "짧고 자주 훈련하기" },
    summary: { ko: "한 번에 오래 하기보다 3~5분씩 자주 연습하는 편이 집중에 좋아요.", en: "한 번에 오래 하기보다 3~5분씩 자주 연습하는 편이 집중에 좋아요." },
    body: { ko: "한 번에 오래 하기보다 3~5분씩 자주 연습하는 편이 집중에 좋아요. 아이마다 나이·체형·건강 상태가 다르므로 이상이 있거나 판단이 어려우면 수의사 또는 전문가와 상담해주세요.", en: "한 번에 오래 하기보다 3~5분씩 자주 연습하는 편이 집중에 좋아요." } },
  { id: "t63", category: "training", featured: false,
    title: { ko: "성공 직후 바로 칭찬하기", en: "성공 직후 바로 칭찬하기" },
    summary: { ko: "행동 후 1~2초 안에 보상해야 어떤 행동이 좋았는지 이해하기 쉬워요.", en: "행동 후 1~2초 안에 보상해야 어떤 행동이 좋았는지 이해하기 쉬워요." },
    body: { ko: "행동 후 1~2초 안에 보상해야 어떤 행동이 좋았는지 이해하기 쉬워요. 아이마다 나이·체형·건강 상태가 다르므로 이상이 있거나 판단이 어려우면 수의사 또는 전문가와 상담해주세요.", en: "행동 후 1~2초 안에 보상해야 어떤 행동이 좋았는지 이해하기 쉬워요." } },
  { id: "t64", category: "training", featured: false,
    title: { ko: "가족의 신호어 통일하기", en: "가족의 신호어 통일하기" },
    summary: { ko: "앉아·기다려 같은 신호어는 가족 모두 같은 단어를 사용하는 게 좋아요.", en: "앉아·기다려 같은 신호어는 가족 모두 같은 단어를 사용하는 게 좋아요." },
    body: { ko: "앉아·기다려 같은 신호어는 가족 모두 같은 단어를 사용하는 게 좋아요. 아이마다 나이·체형·건강 상태가 다르므로 이상이 있거나 판단이 어려우면 수의사 또는 전문가와 상담해주세요.", en: "앉아·기다려 같은 신호어는 가족 모두 같은 단어를 사용하는 게 좋아요." } },
  { id: "t65", category: "training", featured: false,
    title: { ko: "실수했을 때 큰소리 내지 않기", en: "실수했을 때 큰소리 내지 않기" },
    summary: { ko: "혼내기보다 원하는 행동을 다시 유도하고 성공했을 때 보상해주세요.", en: "혼내기보다 원하는 행동을 다시 유도하고 성공했을 때 보상해주세요." },
    body: { ko: "혼내기보다 원하는 행동을 다시 유도하고 성공했을 때 보상해주세요. 아이마다 나이·체형·건강 상태가 다르므로 이상이 있거나 판단이 어려우면 수의사 또는 전문가와 상담해주세요.", en: "혼내기보다 원하는 행동을 다시 유도하고 성공했을 때 보상해주세요." } },
  { id: "t66", category: "training", featured: false,
    title: { ko: "기다려는 짧은 시간부터", en: "기다려는 짧은 시간부터" },
    summary: { ko: "1초 성공부터 시작해 조금씩 시간을 늘리면 실패가 줄어요.", en: "1초 성공부터 시작해 조금씩 시간을 늘리면 실패가 줄어요." },
    body: { ko: "1초 성공부터 시작해 조금씩 시간을 늘리면 실패가 줄어요. 아이마다 나이·체형·건강 상태가 다르므로 이상이 있거나 판단이 어려우면 수의사 또는 전문가와 상담해주세요.", en: "1초 성공부터 시작해 조금씩 시간을 늘리면 실패가 줄어요." } },
  { id: "t67", category: "training", featured: false,
    title: { ko: "산책 전 흥분 낮추기", en: "산책 전 흥분 낮추기" },
    summary: { ko: "문 앞에서 잠깐 기다렸다가 차분해졌을 때 출발하는 습관을 만들어보세요.", en: "문 앞에서 잠깐 기다렸다가 차분해졌을 때 출발하는 습관을 만들어보세요." },
    body: { ko: "문 앞에서 잠깐 기다렸다가 차분해졌을 때 출발하는 습관을 만들어보세요. 아이마다 나이·체형·건강 상태가 다르므로 이상이 있거나 판단이 어려우면 수의사 또는 전문가와 상담해주세요.", en: "문 앞에서 잠깐 기다렸다가 차분해졌을 때 출발하는 습관을 만들어보세요." } },
  { id: "t68", category: "training", featured: false,
    title: { ko: "하우스는 벌주는 곳이 아니에요", en: "하우스는 벌주는 곳이 아니에요" },
    summary: { ko: "하우스 안에서 간식과 휴식을 경험하게 해 편안한 공간으로 만들어주세요.", en: "하우스 안에서 간식과 휴식을 경험하게 해 편안한 공간으로 만들어주세요." },
    body: { ko: "하우스 안에서 간식과 휴식을 경험하게 해 편안한 공간으로 만들어주세요. 아이마다 나이·체형·건강 상태가 다르므로 이상이 있거나 판단이 어려우면 수의사 또는 전문가와 상담해주세요.", en: "하우스 안에서 간식과 휴식을 경험하게 해 편안한 공간으로 만들어주세요." } },
  { id: "t69", category: "training", featured: false,
    title: { ko: "사회화는 거리 조절이 핵심", en: "사회화는 거리 조절이 핵심" },
    summary: { ko: "무조건 가까이 데려가기보다 편안함을 유지할 수 있는 거리에서 경험시켜주세요.", en: "무조건 가까이 데려가기보다 편안함을 유지할 수 있는 거리에서 경험시켜주세요." },
    body: { ko: "무조건 가까이 데려가기보다 편안함을 유지할 수 있는 거리에서 경험시켜주세요. 아이마다 나이·체형·건강 상태가 다르므로 이상이 있거나 판단이 어려우면 수의사 또는 전문가와 상담해주세요.", en: "무조건 가까이 데려가기보다 편안함을 유지할 수 있는 거리에서 경험시켜주세요." } },
  { id: "t70", category: "training", featured: false,
    title: { ko: "문제행동 전 상황을 기록하기", en: "문제행동 전 상황을 기록하기" },
    summary: { ko: "언제·어디서·무엇 직후 행동했는지 적으면 원인을 찾고 훈련하기 쉬워져요.", en: "언제·어디서·무엇 직후 행동했는지 적으면 원인을 찾고 훈련하기 쉬워져요." },
    body: { ko: "언제·어디서·무엇 직후 행동했는지 적으면 원인을 찾고 훈련하기 쉬워져요. 아이마다 나이·체형·건강 상태가 다르므로 이상이 있거나 판단이 어려우면 수의사 또는 전문가와 상담해주세요.", en: "언제·어디서·무엇 직후 행동했는지 적으면 원인을 찾고 훈련하기 쉬워져요." } },
  { id: "t71", category: "safety", featured: false,
    title: { ko: "현관문 열기 전 위치 확인", en: "현관문 열기 전 위치 확인" },
    summary: { ko: "택배나 외출 때 갑자기 뛰어나가지 않도록 문을 열기 전 아이 위치를 확인하세요.", en: "택배나 외출 때 갑자기 뛰어나가지 않도록 문을 열기 전 아이 위치를 확인하세요." },
    body: { ko: "택배나 외출 때 갑자기 뛰어나가지 않도록 문을 열기 전 아이 위치를 확인하세요. 아이마다 나이·체형·건강 상태가 다르므로 이상이 있거나 판단이 어려우면 수의사 또는 전문가와 상담해주세요.", en: "택배나 외출 때 갑자기 뛰어나가지 않도록 문을 열기 전 아이 위치를 확인하세요." } },
  { id: "t72", category: "safety", featured: false,
    title: { ko: "목줄·하네스 마모 점검", en: "목줄·하네스 마모 점검" },
    summary: { ko: "끈이나 버클이 닳거나 갈라지지 않았는지 산책 전에 가볍게 확인해주세요.", en: "끈이나 버클이 닳거나 갈라지지 않았는지 산책 전에 가볍게 확인해주세요." },
    body: { ko: "끈이나 버클이 닳거나 갈라지지 않았는지 산책 전에 가볍게 확인해주세요. 아이마다 나이·체형·건강 상태가 다르므로 이상이 있거나 판단이 어려우면 수의사 또는 전문가와 상담해주세요.", en: "끈이나 버클이 닳거나 갈라지지 않았는지 산책 전에 가볍게 확인해주세요." } },
  { id: "t73", category: "safety", featured: false,
    title: { ko: "차 안에 혼자 두지 않기", en: "차 안에 혼자 두지 않기" },
    summary: { ko: "짧은 시간에도 차량 내부 온도는 빠르게 변할 수 있어요.", en: "짧은 시간에도 차량 내부 온도는 빠르게 변할 수 있어요." },
    body: { ko: "짧은 시간에도 차량 내부 온도는 빠르게 변할 수 있어요. 아이마다 나이·체형·건강 상태가 다르므로 이상이 있거나 판단이 어려우면 수의사 또는 전문가와 상담해주세요.", en: "짧은 시간에도 차량 내부 온도는 빠르게 변할 수 있어요." } },
  { id: "t74", category: "safety", featured: false,
    title: { ko: "약과 세제는 높은 곳에", en: "약과 세제는 높은 곳에" },
    summary: { ko: "사람 약·세제·살충제는 반려동물이 열 수 없는 곳에 보관하세요.", en: "사람 약·세제·살충제는 반려동물이 열 수 없는 곳에 보관하세요." },
    body: { ko: "사람 약·세제·살충제는 반려동물이 열 수 없는 곳에 보관하세요. 아이마다 나이·체형·건강 상태가 다르므로 이상이 있거나 판단이 어려우면 수의사 또는 전문가와 상담해주세요.", en: "사람 약·세제·살충제는 반려동물이 열 수 없는 곳에 보관하세요." } },
  { id: "t75", category: "safety", featured: false,
    title: { ko: "작은 물건 삼킴 주의", en: "작은 물건 삼킴 주의" },
    summary: { ko: "고무줄·동전·건전지·작은 장난감은 바닥에 두지 않는 게 안전해요.", en: "고무줄·동전·건전지·작은 장난감은 바닥에 두지 않는 게 안전해요." },
    body: { ko: "고무줄·동전·건전지·작은 장난감은 바닥에 두지 않는 게 안전해요. 아이마다 나이·체형·건강 상태가 다르므로 이상이 있거나 판단이 어려우면 수의사 또는 전문가와 상담해주세요.", en: "고무줄·동전·건전지·작은 장난감은 바닥에 두지 않는 게 안전해요." } },
  { id: "t76", category: "safety", featured: false,
    title: { ko: "여름 아스팔트 온도 확인", en: "여름 아스팔트 온도 확인" },
    summary: { ko: "손등을 바닥에 대기 힘들 정도로 뜨거우면 산책 시간을 바꿔주세요.", en: "손등을 바닥에 대기 힘들 정도로 뜨거우면 산책 시간을 바꿔주세요." },
    body: { ko: "손등을 바닥에 대기 힘들 정도로 뜨거우면 산책 시간을 바꿔주세요. 아이마다 나이·체형·건강 상태가 다르므로 이상이 있거나 판단이 어려우면 수의사 또는 전문가와 상담해주세요.", en: "손등을 바닥에 대기 힘들 정도로 뜨거우면 산책 시간을 바꿔주세요." } },
  { id: "t77", category: "safety", featured: false,
    title: { ko: "겨울 제설제 닦아주기", en: "겨울 제설제 닦아주기" },
    summary: { ko: "산책 후 발바닥에 묻은 제설제나 오염물을 미지근한 물로 닦아주세요.", en: "산책 후 발바닥에 묻은 제설제나 오염물을 미지근한 물로 닦아주세요." },
    body: { ko: "산책 후 발바닥에 묻은 제설제나 오염물을 미지근한 물로 닦아주세요. 아이마다 나이·체형·건강 상태가 다르므로 이상이 있거나 판단이 어려우면 수의사 또는 전문가와 상담해주세요.", en: "산책 후 발바닥에 묻은 제설제나 오염물을 미지근한 물로 닦아주세요." } },
  { id: "t78", category: "safety", featured: false,
    title: { ko: "창문·베란다 추락 방지", en: "창문·베란다 추락 방지" },
    summary: { ko: "방충망만 믿지 말고 안전망이나 잠금장치를 추가로 확인해주세요.", en: "방충망만 믿지 말고 안전망이나 잠금장치를 추가로 확인해주세요." },
    body: { ko: "방충망만 믿지 말고 안전망이나 잠금장치를 추가로 확인해주세요. 아이마다 나이·체형·건강 상태가 다르므로 이상이 있거나 판단이 어려우면 수의사 또는 전문가와 상담해주세요.", en: "방충망만 믿지 말고 안전망이나 잠금장치를 추가로 확인해주세요." } },
  { id: "t79", category: "safety", featured: false,
    title: { ko: "응급 연락처 저장하기", en: "응급 연락처 저장하기" },
    summary: { ko: "가까운 24시간 동물병원과 주치의 연락처를 휴대폰에 미리 저장해두세요.", en: "가까운 24시간 동물병원과 주치의 연락처를 휴대폰에 미리 저장해두세요." },
    body: { ko: "가까운 24시간 동물병원과 주치의 연락처를 휴대폰에 미리 저장해두세요. 아이마다 나이·체형·건강 상태가 다르므로 이상이 있거나 판단이 어려우면 수의사 또는 전문가와 상담해주세요.", en: "가까운 24시간 동물병원과 주치의 연락처를 휴대폰에 미리 저장해두세요." } },
  { id: "t80", category: "safety", featured: false,
    title: { ko: "여행 전 인식표 확인", en: "여행 전 인식표 확인" },
    summary: { ko: "외출·여행 전 인식표 연락처가 최신인지 확인하면 만일의 상황에 도움이 돼요.", en: "외출·여행 전 인식표 연락처가 최신인지 확인하면 만일의 상황에 도움이 돼요." },
    body: { ko: "외출·여행 전 인식표 연락처가 최신인지 확인하면 만일의 상황에 도움이 돼요. 아이마다 나이·체형·건강 상태가 다르므로 이상이 있거나 판단이 어려우면 수의사 또는 전문가와 상담해주세요.", en: "외출·여행 전 인식표 연락처가 최신인지 확인하면 만일의 상황에 도움이 돼요." } },
  { id: "t81", category: "grooming", featured: false,
    title: { ko: "빗질은 짧게 자주", en: "빗질은 짧게 자주" },
    summary: { ko: "엉킨 뒤 한꺼번에 풀기보다 짧게 자주 빗어주면 피부 확인도 쉬워요.", en: "엉킨 뒤 한꺼번에 풀기보다 짧게 자주 빗어주면 피부 확인도 쉬워요." },
    body: { ko: "엉킨 뒤 한꺼번에 풀기보다 짧게 자주 빗어주면 피부 확인도 쉬워요. 아이마다 나이·체형·건강 상태가 다르므로 이상이 있거나 판단이 어려우면 수의사 또는 전문가와 상담해주세요.", en: "엉킨 뒤 한꺼번에 풀기보다 짧게 자주 빗어주면 피부 확인도 쉬워요." } },
  { id: "t82", category: "grooming", featured: false,
    title: { ko: "목욕 후 속털까지 말리기", en: "목욕 후 속털까지 말리기" },
    summary: { ko: "겉만 마른 것처럼 보여도 속털이 젖어 있으면 피부가 습해질 수 있어요.", en: "겉만 마른 것처럼 보여도 속털이 젖어 있으면 피부가 습해질 수 있어요." },
    body: { ko: "겉만 마른 것처럼 보여도 속털이 젖어 있으면 피부가 습해질 수 있어요. 아이마다 나이·체형·건강 상태가 다르므로 이상이 있거나 판단이 어려우면 수의사 또는 전문가와 상담해주세요.", en: "겉만 마른 것처럼 보여도 속털이 젖어 있으면 피부가 습해질 수 있어요." } },
  { id: "t83", category: "grooming", featured: false,
    title: { ko: "귀 청소는 보이는 부분만", en: "귀 청소는 보이는 부분만" },
    summary: { ko: "면봉을 깊게 넣지 말고 전용 제품으로 보이는 부분을 부드럽게 관리하세요.", en: "면봉을 깊게 넣지 말고 전용 제품으로 보이는 부분을 부드럽게 관리하세요." },
    body: { ko: "면봉을 깊게 넣지 말고 전용 제품으로 보이는 부분을 부드럽게 관리하세요. 아이마다 나이·체형·건강 상태가 다르므로 이상이 있거나 판단이 어려우면 수의사 또는 전문가와 상담해주세요.", en: "면봉을 깊게 넣지 말고 전용 제품으로 보이는 부분을 부드럽게 관리하세요." } },
  { id: "t84", category: "grooming", featured: false,
    title: { ko: "발톱은 조금씩 자르기", en: "발톱은 조금씩 자르기" },
    summary: { ko: "혈관 위치가 불확실하면 아주 조금씩 자르고 어려우면 전문가 도움을 받으세요.", en: "혈관 위치가 불확실하면 아주 조금씩 자르고 어려우면 전문가 도움을 받으세요." },
    body: { ko: "혈관 위치가 불확실하면 아주 조금씩 자르고 어려우면 전문가 도움을 받으세요. 아이마다 나이·체형·건강 상태가 다르므로 이상이 있거나 판단이 어려우면 수의사 또는 전문가와 상담해주세요.", en: "혈관 위치가 불확실하면 아주 조금씩 자르고 어려우면 전문가 도움을 받으세요." } },
  { id: "t85", category: "grooming", featured: false,
    title: { ko: "발바닥 털 미끄럼 주의", en: "발바닥 털 미끄럼 주의" },
    summary: { ko: "패드 사이 털이 너무 길면 미끄러울 수 있어 주기적으로 정리해주세요.", en: "패드 사이 털이 너무 길면 미끄러울 수 있어 주기적으로 정리해주세요." },
    body: { ko: "패드 사이 털이 너무 길면 미끄러울 수 있어 주기적으로 정리해주세요. 아이마다 나이·체형·건강 상태가 다르므로 이상이 있거나 판단이 어려우면 수의사 또는 전문가와 상담해주세요.", en: "패드 사이 털이 너무 길면 미끄러울 수 있어 주기적으로 정리해주세요." } },
  { id: "t86", category: "grooming", featured: false,
    title: { ko: "눈곱은 굳기 전에 닦기", en: "눈곱은 굳기 전에 닦기" },
    summary: { ko: "미지근한 물에 적신 거즈로 눈 주변을 안쪽에서 바깥쪽으로 부드럽게 닦아주세요.", en: "미지근한 물에 적신 거즈로 눈 주변을 안쪽에서 바깥쪽으로 부드럽게 닦아주세요." },
    body: { ko: "미지근한 물에 적신 거즈로 눈 주변을 안쪽에서 바깥쪽으로 부드럽게 닦아주세요. 아이마다 나이·체형·건강 상태가 다르므로 이상이 있거나 판단이 어려우면 수의사 또는 전문가와 상담해주세요.", en: "미지근한 물에 적신 거즈로 눈 주변을 안쪽에서 바깥쪽으로 부드럽게 닦아주세요." } },
  { id: "t87", category: "grooming", featured: false,
    title: { ko: "칫솔질은 적응부터", en: "칫솔질은 적응부터" },
    summary: { ko: "처음부터 오래 닦기보다 입 주변 만지기부터 단계적으로 익숙하게 해주세요.", en: "처음부터 오래 닦기보다 입 주변 만지기부터 단계적으로 익숙하게 해주세요." },
    body: { ko: "처음부터 오래 닦기보다 입 주변 만지기부터 단계적으로 익숙하게 해주세요. 아이마다 나이·체형·건강 상태가 다르므로 이상이 있거나 판단이 어려우면 수의사 또는 전문가와 상담해주세요.", en: "처음부터 오래 닦기보다 입 주변 만지기부터 단계적으로 익숙하게 해주세요." } },
  { id: "t88", category: "grooming", featured: false,
    title: { ko: "미용 도구는 아이 전용으로", en: "미용 도구는 아이 전용으로" },
    summary: { ko: "빗·가위·수건을 깨끗하게 관리하고 다른 동물과 공유하지 않는 게 좋아요.", en: "빗·가위·수건을 깨끗하게 관리하고 다른 동물과 공유하지 않는 게 좋아요." },
    body: { ko: "빗·가위·수건을 깨끗하게 관리하고 다른 동물과 공유하지 않는 게 좋아요. 아이마다 나이·체형·건강 상태가 다르므로 이상이 있거나 판단이 어려우면 수의사 또는 전문가와 상담해주세요.", en: "빗·가위·수건을 깨끗하게 관리하고 다른 동물과 공유하지 않는 게 좋아요." } },
  { id: "t89", category: "grooming", featured: false,
    title: { ko: "피부 붉음과 냄새 확인", en: "피부 붉음과 냄새 확인" },
    summary: { ko: "빗질이나 목욕 때 피부의 붉은 부위·각질·평소와 다른 냄새를 함께 확인하세요.", en: "빗질이나 목욕 때 피부의 붉은 부위·각질·평소와 다른 냄새를 함께 확인하세요." },
    body: { ko: "빗질이나 목욕 때 피부의 붉은 부위·각질·평소와 다른 냄새를 함께 확인하세요. 아이마다 나이·체형·건강 상태가 다르므로 이상이 있거나 판단이 어려우면 수의사 또는 전문가와 상담해주세요.", en: "빗질이나 목욕 때 피부의 붉은 부위·각질·평소와 다른 냄새를 함께 확인하세요." } },
  { id: "t90", category: "grooming", featured: false,
  ...
  { id: "t187", category: "dog", featured: false,
    title: { ko: "산책 후 발바닥과 발가락 사이를 확인해요", en: "Check paws and between toes after walks" },
    summary: { ko: "산책길의 작은 돌, 씨앗, 흙이나 이물질이 발 사이에 남아 불편함을 줄 수 있어요.", en: "Small stones, seeds, dirt, or debris can remain between the toes after a walk." },
    body: { ko: "귀가 후 발바닥과 발가락 사이를 가볍게 살펴보고 젖었거나 더러우면 닦은 뒤 잘 말려 주세요. 상처·절뚝거림·계속 핥는 행동이 보이면 수의사와 상담하세요.", en: "After walks, gently inspect paw pads and between the toes, clean if needed, and dry well. Contact a veterinarian if you notice wounds, limping, or persistent licking." } },
  { id: "t188", category: "cat", featured: false,
    title: { ko: "화장실 주변 모래도 자주 정리해요", en: "Clean scattered litter around the box regularly" },
    summary: { ko: "화장실 밖으로 나온 모래와 먼지를 정리하면 생활공간을 더 깔끔하게 유지할 수 있어요.", en: "Cleaning scattered litter and dust helps keep the living area tidy." },
    body: { ko: "화장실 주변을 주기적으로 쓸거나 닦고, 청소 후에는 손을 씻어 주세요. 고양이 용품은 제품 라벨의 세척 지침을 따르는 게 좋아요.", en: "Sweep or wipe around the litter box regularly and wash your hands after cleaning. Follow product-label directions when cleaning cat supplies." } },
  { id: "t189", category: "health", featured: true,
    title: { ko: "평소 활력과 행동 패턴을 알아두세요", en: "Know your pet’s normal activity and behavior patterns" },
    summary: { ko: "평소 모습을 알아두면 갑작스러운 변화가 생겼을 때 더 빨리 알아차릴 수 있어요.", en: "Knowing what is normal makes sudden changes easier to notice." },
    body: { ko: "식사, 음수, 배변, 수면, 놀이 같은 평소 패턴을 가볍게 기록해 두세요. 눈에 띄는 변화가 지속되거나 다른 증상이 함께 나타나면 수의사에게 상담하세요.", en: "Keep simple notes on eating, drinking, elimination, sleep, and play. If a noticeable change persists or occurs with other symptoms, contact a veterinarian." } },
  { id: "t190", category: "life", featured: false,
    title: { ko: "반려동물 침구는 정기적으로 세탁해요", en: "Wash pet bedding regularly" },
    summary: { ko: "침구와 담요는 털, 먼지, 오염이 쌓이기 쉬워 정기적인 세척이 도움이 돼요.", en: "Beds and blankets can collect fur, dirt, and debris, so regular cleaning helps." },
    body: { ko: "CDC는 반려동물 침구와 담요 같은 용품을 정기적으로 세척하도록 안내해요. 제품의 세탁 지침을 확인하고 충분히 말린 뒤 다시 사용하세요.", en: "CDC recommends regularly cleaning pet supplies such as beds and blankets. Follow the item’s washing instructions and dry thoroughly before reuse." } },
  { id: "t191", category: "food", featured: true,
    title: { ko: "물그릇은 매일 씻고 깨끗한 물을 채워요", en: "Wash water bowls daily and refill with fresh water" },
    summary: { ko: "물그릇도 음식그릇처럼 오염될 수 있어 정기적인 세척이 필요해요.", en: "Water bowls can become contaminated just like food bowls and need regular cleaning." },
    body: { ko: "FDA와 CDC는 물그릇을 자주 세척하도록 안내해요. 남은 물을 버리고 그릇을 씻어 말린 뒤 깨끗한 물을 채워 주세요.", en: "FDA and CDC recommend frequent cleaning of water bowls. Empty old water, wash and dry the bowl, then refill it with fresh water." } },
  { id: "t192", category: "training", featured: false,
    title: { ko: "새 행동은 방해가 적은 곳에서 먼저 연습해요", en: "Practice new behaviors first in a low-distraction place" },
    summary: { ko: "처음부터 자극이 많은 장소에서 연습하면 집중하기 어려울 수 있어요.", en: "Learning can be harder when a new behavior is practiced in a highly distracting environment." },
    body: { ko: "집처럼 조용한 환경에서 짧게 연습한 뒤 성공이 늘면 복도, 현관, 야외처럼 자극이 많은 곳으로 천천히 넓혀 주세요. 성공 직후 보상하는 일관성도 중요해요.", en: "Start with short practice in a quiet place, then gradually add distractions as success improves. Reward consistently right after the desired behavior." } },
  { id: "t193", category: "safety", featured: false,
    title: { ko: "세척·소독제는 완전히 마른 뒤 반려동물이 접근하게 해요", en: "Let cleaned surfaces dry before pets return" },
    summary: { ko: "일부 소독제는 젖어 있을 때 반려동물에게 위험할 수 있어 제품 지침을 지켜야 해요.", en: "Some disinfectants can be hazardous while wet, so label directions matter." },
    body: { ko: "CDC는 세척제와 소독제를 라벨대로 사용하고 필요한 경우 표면이 완전히 마를 때까지 반려동물의 접근을 막도록 안내해요. 제품은 항상 손이 닿지 않는 곳에 보관하세요.", en: "CDC advises using cleaners and disinfectants exactly as labeled and keeping pets away until surfaces are dry when required. Store products securely out of reach." } },
  { id: "t194", category: "grooming", featured: false,
    title: { ko: "브러시와 빗도 털을 제거하고 정리해요", en: "Remove trapped fur from brushes and combs" },
    summary: { ko: "미용도구에 쌓인 털과 먼지를 정리하면 다음 사용 때 더 깔끔하게 관리할 수 있어요.", en: "Removing fur and debris from grooming tools keeps them cleaner for the next use." },
    body: { ko: "사용 후 브러시와 빗에 낀 털을 제거하고 제품 재질에 맞는 방법으로 닦아 충분히 말려 보관하세요. 피부병이 있거나 여러 동물이 함께 쓰는 경우에는 수의사에게 적절한 위생 관리법을 문의하세요.", en: "After use, remove trapped fur, clean according to the tool material, and dry thoroughly before storage. If a pet has a skin condition or tools are shared, ask a veterinarian about appropriate hygiene." } },
