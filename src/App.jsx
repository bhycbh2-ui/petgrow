...
const PetGrowLogo = ({ style }) => (
  <img src={PETGROW_LOGO_DATA_URI} alt="PetGrow" style={{ ...style, borderRadius: "50%", objectFit: "cover", display: "block" }} />
);
...
function PrivacyPage() {
  return (
    <div className="bboggl-root" style={{ minHeight: "100vh" }}>
      <GlobalStyle />
      <div style={{ maxWidth: 640, margin: "0 auto", padding: "32px 0 0" }}>
