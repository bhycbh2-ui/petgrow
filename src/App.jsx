...
function NearbyPetPage(){
  ...
  return <div className="nearby-page">
    ...
    <p className="nearby-disclaimer">업체 정보는 카카오 장소검색 결과를 기반으로 검색 시점에 불러오며 PetGrow가 업체 정보를 별도로 매주 갱신하지 않습니다. 실제 영업 여부·주소와 제공되는 연락처 정보는 변경될 수 있으니 방문 전 업체에 확인해주세요. 이용후기는 PetGrow 회원이 작성한 의견으로 업체의 공식 정보가 아닙니다.</p>
  </div>;
}
