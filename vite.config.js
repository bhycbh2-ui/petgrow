...
import petgrowV6SizeInspect from "./build/petgrow-v6-size-inspect.mjs";
...
export default defineConfig({
  plugins: [petgrowAdsenseWeb(), petgrowV6SizeInspect(), petgrowPerformanceLazy(), petNewsLoadingState(), petInfoCmsSource(), petgrowUiFixes(), petgrowStabilityCleanup(), petgrowNewsPetTalkTarotFixes(), petgrowMenuSplitV3(), petgrowMenuSplitV4(), petgrowPetTalkSplitV5(), react()],
  build: {
    rollupOptions: {
      output: {
        manualChunks(id) {
